  ...
  return (
      ...
      <div className="flex flex-col bg-slate-50 text-slate-900">
        ...
        <section className="text-[11px] text-slate-700 space-y-2 mb-4">
          ...
          <p>
            Beamio creates a wallet on your device for <span className="font-medium">USDC</span>. You can use it to send and receive small payments with <span className="font-medium">no gas fees</span>. This wallet is self-custodial – funds go directly to you.
          </p>
        </section>
