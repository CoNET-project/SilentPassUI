...
const SelectActivePassportPopup = ({ currentPassportName, currentPassportExpiration, newPassportName, newPassportExpirationDays }: any) => {
  const { profiles, isSelectPassportPopupOpen, setIsSelectPassportPopupOpen } = useDaemonContext();
