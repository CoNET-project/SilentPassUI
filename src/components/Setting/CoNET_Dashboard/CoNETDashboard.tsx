...
import styles from './CoNETDashboard.module.scss'
import CoNETDashboard from './index'
...
const CoNET_Dashboard = ({visible,setVisible}:faqParams) => {
...
export default CoNET_Dashboard;