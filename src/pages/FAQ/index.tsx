  	...
  	return (
  		<div className={styles.wrap}>
  			...
  			<div className={styles.content}>
	  			<Collapse accordion>
	          		<Collapse.Panel key='1' title={t('faq1')}>
	            		<p>{t('faq1-1')} <br /> {t('faq1-2')}</p>
	            		<div className={styles.table}>
	            			<table>
	            				<tbody>
	            					<tr>
	            						<TableCell> </TableCell>
	            						<TableCell>{t('faq1-3')}</TableCell>
	            						<TableCell>{t('faq1-4')}</TableCell>
	            						<TableCell>{t('faq1-5')}</TableCell>
	            					</tr>
	            					<tr>
	            						<TableCell>{t('faq1-6')}</TableCell>
	            						<TableCell><CheckCircleOutline className={styles.icon} />{t('faq1-7')}</TableCell>
	            						<TableCell><CheckCircleOutline className={styles.icon} />{t('faq1-8')}</TableCell>
	            						<TableCell><CheckCircleOutline className={styles.icon} /></TableCell>
	            					</tr>
	            					<tr>
	            						<TableCell>{t('faq1-9')}</TableCell>
