      ...
      <div className="px-4 pb-4 overflow-y-auto">
        ...
        
		{
			...
			receiptId && <>
				...
				<div className="px-4 pb-4">
					...
					<button
						...
						title={copied === "receipt" ? "已复制" : tu('copy')}
					>
          ...
          {/* transaction */}
            ...
            <div className="text-[16px] font-extrabold text-slate-900 mb-2">{tu('transaction')}</div>
        ...
        <div className="mt-3 flex items-center gap-3">
          <ActionBtn icon={<Share2 className="h-5 w-5" />} label={tu('share')} onClick={() => onShare?.(data)} />
          <ActionBtn icon={<Download className="h-5 w-5" />} label={tu('save')} onClick={() => onPdf?.(data)} />
        </div>
