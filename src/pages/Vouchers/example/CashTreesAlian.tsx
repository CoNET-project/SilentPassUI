              ...
              <div className="max-w-5xl space-y-8 animate-in slide-in-from-bottom-4 duration-500">
                    ...
                    <div>
                        ...
                        <div className="mt-5 space-y-3">
                            <div className="flex items-center gap-2">
                               ...
                               <span className="bg-emerald-50 text-emerald-700 px-3 py-1 rounded-md text-sm font-mono font-bold">@CashTrees</span>
                            </div>
                            <div className="flex items-center gap-2">
                               <Wallet size={18} className="text-slate-400"/>
                               <span className="font-bold text-slate-700 w-24">EOA Wallet:</span> 
                               <span className="text-slate-500 font-mono text-sm bg-slate-50 px-3 py-1 rounded-md border border-slate-100">0x1A4b...3992</span>
                            </div>
                            <div className="flex items-center gap-2">
                               <Cpu size={18} className="text-blue-500"/>
                               <span className="font-bold text-slate-700 w-24">AA Smart Acc:</span> 
                               <span className="text-slate-500 font-mono text-sm bg-slate-50 px-3 py-1 rounded-md border border-slate-100">{deployedContractAddress}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-3xl border border-slate-200 shadow-sm p-8 flex flex-col">
                       ...
                       <div className="space-y-4 flex-1">
                          <div className="bg-slate-50 p-4 rounded-xl border border-slate-100">
                             ...
                             <div className="font-mono text-sm text-slate-700">0x1A4b...3992</div>
                          </div>
                          ...
                          <div className="bg-slate-50 p-4 rounded-xl border border-slate-100">
                             ...
                             <div className="font-bold text-lg text-slate-900 flex items-center gap-2">
                                ...
                                15,000.00 <span className="text-sm text-slate-500 font-medium">USDC</span>
                             </div>
                          </div>
                       </div>
                    </div>
                    ...
                    <div className="bg-slate-900 rounded-3xl shadow-xl p-8 flex flex-col text-white relative overflow-hidden">
                       ...
                       <div className="space-y-4 flex-1 relative z-10">
                          <div className="bg-slate-800/50 p-4 rounded-xl border border-slate-700">
                             ...
                             <div className="font-mono text-sm text-emerald-400">{deployedContractAddress}</div>
                          </div>
                          ...
                          <div className="bg-slate-800/50 p-4 rounded-xl border border-slate-700">
                             ...
                             <div className="font-bold text-2xl text-white flex items-center gap-2">
                                ...
                                85,400.00 <span className="text-sm text-slate-400 font-medium">USDC</span>
                             </div>
                 ...
                 <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 flex items-center justify-between">
                    ...
                    <div className="text-right">
                       <div className="text-2xl font-black text-slate-900">845,000 <span className="text-sm text-slate-400 font-bold">Units</span></div>
                       <div className="text-xs text-slate-400 mt-1 font-mono">≈ $8,450.00 USDC</div>
                    </div>
