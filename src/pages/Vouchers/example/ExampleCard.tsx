     ...
     <div className="relative w-full max-w-md bg-[#F2F2F7] rounded-t-[32px] shadow-2xl overflow-hidden animate-slide-up pb-8 border-t border-white/20">
       ...
       <div className="px-6 pb-6">
          ...
          <div className="relative h-[60px]">
             ...
             {step === 'success' && <div className="w-full h-full bg-green-500 text-white rounded-[20px] font-bold text-[17px] flex items-center justify-center gap-2 animate-scale-in"><Check size={28} strokeWidth={3} />{isFree ? "已领取" : "Purchased"}</div>}
          </div>
...
export default function BeamioMarketPage() {
 ...
 const finalizeGenesis = () => {
   ...
   const newItem = { id: newId, date: '刚刚', balance: 'ACTIVE' };
   ...
   // Re-open detail to show "我的钱包" state
     ...
     <div className="relative w-full max-w-md h-[850px] bg-[#F2F2F7] sm:rounded-[50px] shadow-2xl overflow-hidden border-[8px] border-black flex flex-col">
       ...
       <div className="flex-1 overflow-y-auto scrollbar-hide pb-20">
         ...
         <div className="px-6 pt-16 pb-4 flex justify-between items-end bg-[#F2F2F7]/90 backdrop-blur-xl sticky top-0 z-40 border-b border-gray-200/50">
           <h1 className="text-[34px] font-bold text-black tracking-tight leading-none">市场</h1>
           <div className="w-10 h-10 rounded-full bg-gray-200 border border-white overflow-hidden active:scale-95 transition-transform cursor-pointer"><IpfsImg src="https://api.dicebear.com/7.x/avataaars/svg?seed=Felix" alt="个人资料" /></div>
         </div>
