...
function WalletMerchantPassStackCardInner({ display, stackIdx, topPx }: Props) {
	...
	return (
		<div
			className="stack-card absolute left-0 right-0 flex flex-col rounded-[1.5rem] border border-white/10 p-5 text-left text-white shadow-[0_-8px_24px_rgba(0,0,0,0.12)]"
			style={{
				top: topPx,
				zIndex: stackIdx + 1,
				height: STACK_CARD_H,
