...
const chats = [
  	{ id: '1', name: 'Coco Xie', avatar:'https://api.dicebear.com/8.x/fun-emoji/svg?seed=%40Beamio', last: "Got it, I'll send the Beamio link later.", time: '10:21', unread: 2 },
  	...
  	{ id: '5', name: 'Coco Xie', avatar:'https://api.dicebear.com/8.x/fun-emoji/svg?seed=%40Beamio', last: "Got it, I'll send the Beamio link later.", time: '10:21', unread: 2 },
  	...
  	{ id: '9', name: 'Coco Xie', avatar:'https://api.dicebear.com/8.x/fun-emoji/svg?seed=%40Beamio', last: "Got it, I'll send the Beamio link later.", time: '10:21', unread: 2 },
  	...
  	{ id: '13', name: 'Coco Xie', avatar:'https://api.dicebear.com/8.x/fun-emoji/svg?seed=%40Beamio', last: "Got it, I'll send the Beamio link later.", time: '10:21', unread: 2 },
  	...
  	{ id: '17', name: 'Coco Xie', avatar:'https://api.dicebear.com/8.x/fun-emoji/svg?seed=%40Beamio', last: "Got it, I'll send the Beamio link later.", time: '10:21', unread: 2 },
