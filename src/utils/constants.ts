...
import { baseEndpoint, baseRpcProviderDirect } from './baseRpc'
import { BEAMIO_USER_CARD_ASSET_ADDRESS as BEAMIO_USER_CARD_ASSET } from '../config/chainAddresses'
...
const _envConetWss =
	typeof process !== 'undefined'
		...
		: undefined
export const CONET_MAINNET_WSS = _envConetWss || 'wss://publicrpc.conet.network/ws';
...
/** 链上基础设施 BeamioUserCard（仅作地址常量；biz 不将 CCSA/infra 当作用户程序卡使用） */
