...
export type VoiceCallSignalType = 'voice_call_offer_v1' | 'voice_call_accept_v1' | 'voice_call_reject_v1' | 'voice_end_v1';
...
export declare const VOICE_CALL_MAX_DURATION_MS: number;
...
export type ChatStatus = 'idle' | 'connecting' | 'listening' | 'reconnecting' | 'paused' | 'error';
...
export interface BeamioChatClient {
    ...
    sendMessage(to: ChatRoute, payload: string, opts?: SendMessageOptions): Promise<{
        sendId: string;
    }>;
